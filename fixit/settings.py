...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-y6ocrt!wuwen8k2_7bl4w0x16_2@7mxj2pq*-9wdig7adf9rbe')
...
TEMPLATES = [
    {
        ...
        "DIRS": [os.path.join(BASE_DIR, 'fixit/templates')],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
